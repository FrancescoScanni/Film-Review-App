...
<body class="w-[100%] bg-[#0e56ff] mb-6">

    <div class=" content flex flex-col items-center m-4 bg-[#fff4e1] rounded-[20px]">

        <div class="title mt-[40px]"><b>Cinescope. - Films overview</b></div>

        <div class="intro">
            <h1 class="text-[#000000] text-center px-[32px] text-[36px] font-bold">Browse all available movies and leave your review to share your opinion.</h1>
        </div>
